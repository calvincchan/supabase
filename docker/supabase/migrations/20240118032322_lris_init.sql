...
ALTER TABLE "public"."profile"
ADD CONSTRAINT "profile_case_id_fkey" FOREIGN KEY (case_id) REFERENCES "case" (id) ON DELETE CASCADE NOT VALID;

ALTER TABLE "public"."profile" VALIDATE CONSTRAINT "profile_case_id_fkey";

ALTER TABLE "public"."profile"
ADD CONSTRAINT "profile_gender_check" CHECK (
  (
    gender = ANY (ARRAY['M'::bpchar, 'F'::bpchar, 'U'::bpchar])
  )
) NOT VALID;
...
CREATE
OR REPLACE FUNCTION public.get_role () RETURNS TEXT LANGUAGE plpgsql AS $function$
DECLARE
  v_role CHAR(1);
BEGIN
...
CREATE
OR REPLACE FUNCTION public.trigger_on_session_status () RETURNS TRIGGER LANGUAGE plpgsql AS $function$
BEGIN
...
GRANT
SELECT
  ON TABLE "public"."case" TO "postgres";

GRANT TRIGGER ON TABLE "public"."case" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."case" TO "postgres";

GRANT
UPDATE ON TABLE "public"."case" TO "postgres";
...
GRANT
SELECT
  ON TABLE "public"."case_handler" TO "postgres";

GRANT TRIGGER ON TABLE "public"."case_handler" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."case_handler" TO "postgres";

GRANT
UPDATE ON TABLE "public"."case_handler" TO "postgres";
...
GRANT
TRUNCATE ON TABLE "public"."profile" TO "anon";
...
GRANT
TRUNCATE ON TABLE "public"."profile" TO "authenticated";
...
GRANT
SELECT
  ON TABLE "public"."profile" TO "postgres";

GRANT TRIGGER ON TABLE "public"."profile" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."profile" TO "postgres";

GRANT
UPDATE ON TABLE "public"."profile" TO "postgres";
...
GRANT
TRUNCATE ON TABLE "public"."profile" TO "service_role";
...
GRANT
SELECT
  ON TABLE "public"."progress_note" TO "postgres";

GRANT TRIGGER ON TABLE "public"."progress_note" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."progress_note" TO "postgres";

GRANT
UPDATE ON TABLE "public"."progress_note" TO "postgres";
...
GRANT
SELECT
  ON TABLE "public"."reminder" TO "postgres";

GRANT TRIGGER ON TABLE "public"."reminder" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."reminder" TO "postgres";

GRANT
UPDATE ON TABLE "public"."reminder" TO "postgres";
...
GRANT
SELECT
  ON TABLE "public"."session" TO "postgres";

GRANT TRIGGER ON TABLE "public"."session" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."session" TO "postgres";

GRANT
UPDATE ON TABLE "public"."session" TO "postgres";
...
GRANT
SELECT
  ON TABLE "public"."target" TO "postgres";

GRANT TRIGGER ON TABLE "public"."target" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."target" TO "postgres";

GRANT
UPDATE ON TABLE "public"."target" TO "postgres";
...
GRANT
SELECT
  ON TABLE "public"."team_member" TO "postgres";

GRANT TRIGGER ON TABLE "public"."team_member" TO "postgres";

GRANT
TRUNCATE ON TABLE "public"."team_member" TO "postgres";

GRANT
UPDATE ON TABLE "public"."team_member" TO "postgres";
...
CREATE POLICY "Enable insert for all users" ON "public"."case" AS permissive FOR INSERT TO authenticated
WITH
  CHECK (TRUE);
...
CREATE POLICY "Enable update for creator and managers" ON "public"."case" AS permissive FOR
...
CREATE POLICY "Enable read access for all users" ON "public"."case_handler" AS permissive FOR ALL TO authenticated USING (TRUE)
WITH
  CHECK (TRUE);

CREATE POLICY "Enable all operations for all users" ON "public"."profile" AS permissive FOR ALL TO authenticated USING (TRUE)
WITH
  CHECK (TRUE);

CREATE POLICY "Enable delete for creator and managers" ON "public"."progress_note" AS permissive FOR DELETE TO authenticated USING (
  (
    (auth.uid () = created_by)
    OR is_manager ()
  )
...
CREATE POLICY "Enable insert for all users" ON "public"."progress_note" AS permissive FOR INSERT TO authenticated
WITH
  CHECK (TRUE);
...
CREATE POLICY "Enable update for creator or managers" ON "public"."progress_note" AS permissive FOR
UPDATE TO authenticated USING (TRUE)
WITH
  CHECK (
    (
...
CREATE POLICY "Enable delete for creator and managers" ON "public"."reminder" AS permissive FOR DELETE TO authenticated USING (
  (
    (auth.uid () = created_by)
    OR is_manager ()
  )
...
CREATE POLICY "Enable insert for all users" ON "public"."reminder" AS permissive FOR INSERT TO authenticated
WITH
  CHECK (TRUE);
...
CREATE POLICY "Enable update for creator or managers" ON "public"."reminder" AS permissive FOR
UPDATE TO authenticated USING (TRUE)
WITH
  CHECK (
    (
...
CREATE POLICY "Enable delete for creator and managers" ON "public"."session" AS permissive FOR DELETE TO authenticated USING (
  (
    (auth.uid () = created_by)
    OR is_manager ()
  )
...
CREATE POLICY "Enable insert for all users" ON "public"."session" AS permissive FOR INSERT TO authenticated
WITH
  CHECK (TRUE);
...
CREATE POLICY "Enable update for creator or managers" ON "public"."session" AS permissive FOR
...
CREATE POLICY "Enable all operations for authenticated users" ON "public"."target" AS permissive FOR ALL TO authenticated USING (TRUE)
WITH
  CHECK (TRUE);
...
CREATE POLICY "Enable update for authenticated manager" ON "public"."team_member" AS permissive FOR
UPDATE TO authenticated USING (TRUE)
WITH
  CHECK (
    (
