...
CREATE OR REPLACE VIEW "public"."my_case" AS
 SELECT "a"."id",
    ...
    "a"."case_no"
   FROM "public"."case" "a"
  WHERE (("a"."id" IN ( SELECT "case_handler"."case_id"
           FROM "public"."case_handler"
          WHERE ("case_handler"."user_id" = "auth"."uid"()))) OR ("a"."id" IN ( SELECT "case_gls"."case_id"
...
CREATE OR REPLACE VIEW "public"."safeguarding_note_oplog" AS
 SELECT "rv"."id",
    "rv"."record_id",
    "rv"."old_record_id",
    "rv"."op",
   ...
   FROM ("audit"."record_version" "rv"
     LEFT JOIN "public"."team_member" "tm" ON (("rv"."auth_uid" = "tm"."id")))
  WHERE (("rv"."table_oid" = ('"public"."safeguarding_note"'::"regclass")::"oid") AND ("public"."is_allowed"('safeguarding_note:read_all'::"public"."permission_enum") OR ("rv"."auth_uid" = "auth"."uid"())));
...
CREATE OR REPLACE TRIGGER "audit_i_u_d" AFTER INSERT OR DELETE OR UPDATE ON "public"."safeguarding_note" FOR EACH ROW EXECUTE FUNCTION "audit"."insert_update_delete_trigger"();
...
CREATE OR REPLACE TRIGGER "audit_t" AFTER TRUNCATE ON "public"."safeguarding_note" FOR EACH STATEMENT EXECUTE FUNCTION "audit"."truncate_trigger"();
...
GRANT ALL ON TABLE "public"."safeguarding_note_oplog" TO "postgres";
